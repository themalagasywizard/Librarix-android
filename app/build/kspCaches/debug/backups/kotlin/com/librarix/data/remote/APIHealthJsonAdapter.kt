...
public class APIHealthJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<APIHealth>() {
  ...
  override fun toString(): String = buildString(31) {
      append("GeneratedJsonAdapter(").append("APIHealth").append(')') }

  override fun fromJson(reader: JsonReader): APIHealth {
  ...
  override fun toJson(writer: JsonWriter, value_: APIHealth?) {
    if (value_ == null) {
